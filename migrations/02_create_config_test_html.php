...
class CreateConfigTestHtml extends Migration {
    ...
    public function up() {
        ...
        if (!isset($config["FIREBIEST_TEST_HTML"])) {
            Config::get()->create("FIREBIEST_TEST_HTML", array('section' => "plugins", 'is_default' => 0, 'value' => 0, 'type' => "boolean", 'range' => "global", 'description' => "tests syntax of the html", 'comment' => ""));
        }
	}
